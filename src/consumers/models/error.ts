...
export const hancockGetWalletError = new HancockError('50013', 'Error fetching consumer wallet item');
export const hancockEncryptError = new HancockError('50014', 'Error encrypting message to send');
